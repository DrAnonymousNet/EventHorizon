...
const (
	NotifierService_Notify_FullMethodName = "/NotifierService/Notify"
)
...
func (c *notifierServiceClient) Notify(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotifierService_Notify_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var NotifierService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v1/notifier.proto",
}
